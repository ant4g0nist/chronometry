...
func init() {
	...
	fetchByIndexCmd.Flags().StringVarP(&chronometryServer, "server", "s", "https://chronometry.ant4g0nist.com", "The Chronometry server to use.")
	fetchByRecordCmd.Flags().StringVarP(&chronometryServer, "server", "s", "https://chronometry.ant4g0nist.com", "The Chronometry server to use.")
